<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    <tr>
        <td>Exchange rate</td>
        <td>1 ETRX = <?php echo $details['rate_formatted'].' '.$details['currency']; ?></td>
    </tr>
    <tr>
        <td>Total amount</td>
        <td><?php echo $details['amount_total_formatted']; ?> ETRX</td>
    </tr>
    <tr>
        <td>Total paid</td>
        <td><?php echo $details['amount_paid_formatted']; ?> ETRX</td>
    </tr>
    <tr>
        <td>Total due</td>
        <td><?php echo $details['amount_due_formatted']; ?> ETRX</td>
    </tr>
    <tr>
        <td>Order age</td>
        <td><?php echo traaittplatform_Gateway::format_seconds_to_time($details['order_age']) ?> ago</td>
    </tr>
    <tr>
...
<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    ...
    <tr>
        ...
        <td><?php echo sprintf(TRAAITTPLATFORM_GATEWAY_ATOMIC_UNITS_SPRINTF, $tx['amount'] / TRAAITTPLATFORM_GATEWAY_ATOMIC_UNITS_POW); ?> ETRX</td>
    </tr>
    <?php endforeach; ?>
</table>
<?php endif; ?>
